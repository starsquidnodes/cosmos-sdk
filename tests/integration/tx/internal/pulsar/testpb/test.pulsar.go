...
func init() {
	file_testpb_test_proto_init()
	md_MsgStoreCode = File_testpb_test_proto.Messages().ByName("MsgStoreCode")
...
func (x *fastReflection_MsgStoreCode) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "testpb.MsgStoreCode.sender":
		return x.Sender != ""
	case "testpb.MsgStoreCode.wasm_byte_code":
		return len(x.WasmByteCode) != 0
	case "testpb.MsgStoreCode.instantiate_permission":
		return x.InstantiatePermission != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.MsgStoreCode"))
		}
		panic(fmt.Errorf("message testpb.MsgStoreCode does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgStoreCode) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message testpb.MsgStoreCode does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgStoreCode) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "testpb.MsgStoreCode.sender":
		panic(fmt.Errorf("field sender of message testpb.MsgStoreCode is not mutable"))
	case "testpb.MsgStoreCode.wasm_byte_code":
		panic(fmt.Errorf("field wasm_byte_code of message testpb.MsgStoreCode is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.MsgStoreCode"))
		}
...
func (x *fastReflection_MsgStoreCode) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in testpb.MsgStoreCode", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_testpb_test_proto_init()
	md_AccessConfig = File_testpb_test_proto.Messages().ByName("AccessConfig")
...
func (x *fastReflection_AccessConfig) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "testpb.AccessConfig.permission":
		return x.Permission != 0
	case "testpb.AccessConfig.addresses":
		return len(x.Addresses) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.AccessConfig"))
		}
		panic(fmt.Errorf("message testpb.AccessConfig does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccessConfig) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message testpb.AccessConfig does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccessConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "testpb.AccessConfig.addresses":
		...
		return protoreflect.ValueOfList(value)
	case "testpb.AccessConfig.permission":
		panic(fmt.Errorf("field permission of message testpb.AccessConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.AccessConfig"))
		}
...
func (x *fastReflection_AccessConfig) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in testpb.AccessConfig", d.FullName()))
	}
	panic("unreachable")
}
...
type AccessConfig struct {
	...
	Permission AccessType `protobuf:"varint,1,opt,name=permission,proto3,enum=testpb.AccessType" json:"permission,omitempty"`
...
var file_testpb_test_proto_rawDesc = []byte{
	...
	0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xf4, 0x01, 0x0a, 0x0c, 0x4d, 0x73, 0x67, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x30, 0x0a, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72,
	...
	,
	...
	0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x01, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x2a, 0xf6, 0x01, 0x0a,
	...
	,
...
var file_testpb_test_proto_goTypes = []interface{}{
	(AccessType)(0),            // 0: testpb.AccessType
	(*Streng)(nil),             // 1: testpb.streng
	(*TestRepeatedFields)(nil), // 2: testpb.TestRepeatedFields
	(*TestNullableFields)(nil), // 3: testpb.TestNullableFields
	(*IntAsString)(nil),        // 4: testpb.IntAsString
	(*IntAsBytes)(nil),         // 5: testpb.IntAsBytes
	(*MsgStoreCode)(nil),       // 6: testpb.MsgStoreCode
	(*AccessConfig)(nil),       // 7: testpb.AccessConfig
}
var file_testpb_test_proto_depIdxs = []int32{
	1,  // 0: testpb.TestRepeatedFields.nullable_omitempty:type_name -> testpb.streng
	1,  // 1: testpb.TestRepeatedFields.nullable_dont_omitempty:type_name -> testpb.streng
	1,  // 2: testpb.TestRepeatedFields.non_nullable_omitempty:type_name -> testpb.streng
	1,  // 3: testpb.TestRepeatedFields.non_nullable_dont_omitempty:type_name -> testpb.streng
	1,  // 4: testpb.TestNullableFields.nullable_omitempty:type_name -> testpb.streng
	1,  // 5: testpb.TestNullableFields.nullable_dont_omitempty:type_name -> testpb.streng
	1,  // 6: testpb.TestNullableFields.non_nullable_omitempty:type_name -> testpb.streng
	1,  // 7: testpb.TestNullableFields.non_nullable_dont_omitempty:type_name -> testpb.streng
	7,  // 8: testpb.MsgStoreCode.instantiate_permission:type_name -> testpb.AccessConfig
	0,  // 9: testpb.AccessConfig.permission:type_name -> testpb.AccessType
	2,  // 10: testpb.IntegrationTxTestMsg.TestFields:input_type -> testpb.TestRepeatedFields
	2,  // 11: testpb.IntegrationTxTestMsg.TestFields:output_type -> testpb.TestRepeatedFields
